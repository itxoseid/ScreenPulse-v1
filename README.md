...
`pythonw`, and closes its own console immediately. Only one watcher runs at a
time; running it again while one is active leaves the existing one alone.
